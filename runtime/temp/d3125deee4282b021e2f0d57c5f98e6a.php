...
<body>
    ...
    <li class="active"><a href="<?php echo Url('contact/contactAdd'); ?>">添加联系</a></li>
    <?php endif; ?>
    
</ul>
 <form  class="form-horizontal" action="<?php echo url('contact/contactAdd'); ?>" method="post">
