...
<body>
    ...
    <li class="active"><a href="<?php echo Url('contact/index'); ?>">联系列表</a></li>
        ...
        <table class="table table-hover table-bordered table-list" id="menus-table">
            ...
            <?php foreach($list as $v): ?>
                <tr>
                    ...
                    <td>
                        <?php if(checkPath('contact/inputContact')): ?>
                        <input class="form-control change-data short-input"  post-id="<?php echo $v['id']; ?>" post-url="<?php echo url('contact/inputContact'); ?>" data-name="sort" value="<?php echo $v['sort']; ?>">
                        <?php else: ?>
                        <?php echo $v['sort']; endif; ?>
                    </td>
                    <td>
                        <?php if(checkPath('contact/contactEdit',['id'=>$v['id']])): ?>
                        <a  href="<?php echo url('contact/contactEdit',['id'=>$v['id']]); ?>">编辑</a>
                        <?php endif; if(checkPath('contact/contactDelete',['id'=>$v['id']])): ?>
                            <a  class="span-post" post-msg="确定要删除吗" post-url="<?php echo url('contact/contactDelete',['id'=>$v['id']]); ?>">删除</a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
