<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\wamp64\www\hengtong\web/../appweb/index\view\index\index.php";i:1526522796;s:65:"D:\wamp64\www\hengtong\web/../appweb/index\view\public\header.php";i:1526387006;}*/ ?>
...
<head>
    ...
    <title><?php echo $info['heading']; ?></title>
    ...
    <style>
        ...
        .section1{
            background: url(__ImagePath__<?php echo $info['bg_url']; ?>) no-repeat;
...
<header>
    ...
    <div class="section section1">
        ...
        <h3 class="dh1"><?php echo $info['heading']; ?></h3>
        <p class="dh2" ><?php echo $info['eng_heading']; ?></p>
        <p class="dh3" ><?php echo $info['sub_heading']; ?></p>
    ...
    <div class="section section2" id="yw2">
        ...
        <div class="container yw">
            <div class="row" id="tb">
                <?php foreach($serviceList as $v): ?>
                <div class="col-xs-6 col-md-3 left1" >
                    <div class="img" style="background: url(__ImagePath__<?php echo $v['url']; ?>) no-repeat;background-size: 100%;" ></div>
                    <p><?php echo $v['name']; ?></p>
                </div>
                <?php endforeach; ?>
            </div>
    ...
    <div class="section section3">
        ...
        <div class="container">
            <div class="row" id="al">
                ...
                <a href="<?php echo url('index/caseDetail',['id'=>$v['id']]); ?>">
                    <div class="col-xs-6 col-md-4 bj" >
                        <div class="al1 al2">
                            <div class="al1" style="background: url(__ImagePath__<?php echo $v['url']; ?>) no-repeat;background-size: 100%;">
            ...
            <a href="<?php echo url('index/caseList'); ?>" style="text-decoration: none"> <p class="more" style="background: white"> MORE <span style="margin-left: 4px"> > </span></p></a>
    ...
    <div class="section section4 NO4">
        ...
        <div class="container">
            <div class="row hb2">
                <?php foreach($partnerList as $v): ?>
                <div class="col-xs-6 col-md-3 hb1">
                    <div class="hb"><img src="__ImagePath__<?php echo $v['url']; ?>"></div>
                </div>
                <?php endforeach; ?>
            </div>
    ...
    <div class="section section5 No5">
        ...
        <div class="ht"><img src="__ImagePath__<?php echo $info['sub_url']; ?>"> </div>
    ...
    <div class="section  No6">
        ...
        <div class="ewm">
            <img src="__ImagePath__<?php echo $info['qr_url']; ?>">
        </div>
