<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"D:\wamp64\www\hengtong\admin/../appadmin/base\view\contact\contactEdit.php";i:1526298865;s:67:"D:\wamp64\www\hengtong\admin/../appadmin/base\view\layouts\main.php";i:1524785424;s:69:"D:\wamp64\www\hengtong\admin/../appadmin/base\view\publics\topCss.php";i:1524785424;s:72:"D:\wamp64\www\hengtong\admin/../appadmin/base\view\form\form_contact.php";i:1526298683;s:71:"D:\wamp64\www\hengtong\admin/../appadmin/base\view\publics\bottomJs.php";i:1524785424;}*/ ?>
...
<body>
    ...
    <?php if(checkPath('contact/index')): ?>
    <li><a href="<?php echo Url('contact/index'); ?>">联系列表</a></li>
    <?php endif; if(checkPath('contact/contactAdd')): ?>
    <li><a href="<?php echo Url('contact/contactAdd'); ?>">添加联系</a></li>
    <?php endif; if(checkPath('contact/contactEdit',['id'=>$info['id']])): ?>
    <li class="active"><a href="<?php echo Url('contact/contactEdit',['id'=>$info['id']]); ?>">修改联系</a></li>
    <?php endif; ?>
</ul>
 <form  class="form-horizontal" action="<?php echo url('contact/contactEdit',['id'=>$info['id']]); ?>" method="post">
    ...
    <table class="table table-bordered">
        <tbody>
            <tr>
                <th>联系方式</th>
                <td>
                    <input class="form-control text" type="text" name="name" value="<?php echo isset($info['name']) ? $info['name'] : ''; ?>" placeholder="联系方式">
            ...
            <tr>
                <th>联系信息</th>
                <td>
                    <input class="form-control text" type="text" name="info" value="<?php echo isset($info['info']) ? $info['info'] : ''; ?>" placeholder="联系信息">
                    <span class="form-required">*</span>
                </td>
            </tr>
            <tr>
                <th>联系图片</th>
                <td>
                    <button name="image" type="button" class="layui-btn upload" lay-data="{'url': '<?php echo url('index/upload/image',['type'=>'contact']); ?>'}">
            ...
            <tr>
                <th>排序</th>
                <td>
                    <input class="form-control text" type="text" name="sort" value="<?php echo isset($info['sort']) ? $info['sort'] : ''; ?>" placeholder="排序">
                </td>
            </tr>
            <tr>
