...
<body>
    ...
    <li class="active"><a href="<?php echo Url('caseCategory/categoryAdd'); ?>">添加分类</a></li>
    <?php endif; ?>
    
</ul>
 <form  class="form-horizontal" action="<?php echo url('caseCategory/categoryAdd'); ?>" method="post">
