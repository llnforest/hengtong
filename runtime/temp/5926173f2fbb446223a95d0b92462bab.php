...
<body>
    ...
    <?php endif; if(checkPath('cases/casesEdit',['id'=>$info['id']])): ?>
    <li class="active"><a href="<?php echo Url('cases/casesEdit',['id'=>$info['id']]); ?>">修改案例</a></li>
    <?php endif; ?>
</ul>
 <form  class="form-horizontal" action="<?php echo url('cases/casesEdit',['id'=>$info['id']]); ?>" method="post">
