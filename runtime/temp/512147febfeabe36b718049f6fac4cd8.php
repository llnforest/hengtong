...
<body>
    ...
    <?php endif; if(checkPath('service/serviceEdit',['id'=>$info['id']])): ?>
    <li class="active"><a href="<?php echo Url('service/serviceEdit',['id'=>$info['id']]); ?>">修改业务</a></li>
    <?php endif; ?>
</ul>
 <form  class="form-horizontal" action="<?php echo url('service/serviceEdit',['id'=>$info['id']]); ?>" method="post">
